...
Nowadays one of the most extensive uses of computing is artificial intelligence. Some examples
are when getting recommendations for products that we can buy, based in previous purchases,
or setting the proper camera parameters when taking a picture.
This is being 
used to give us recommendations in which products we can buy based in our previous purchases, 
like Amazon does \cite{neural:amazon}.
