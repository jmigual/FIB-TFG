...
Regarding the medical field, recent deep learning algorithms, specially \ac{CNN} 
...
images generated from \ac{MRI}, \ac{PET} or \ac{CT} scans are vastly underused due to the 
...
extraction. In this case, features are extracted too but a \ac{CNN} 
