...
\DeclareFixedFootnote{\pyradiomics}{\url{https://github.com/Radiomics/pyradiomics}}
...
libraries such as \emph{PyRadiomics}\pyradiomics. This 
...
state-of-the art. One of the biggest handicaps found was the computational intensity of
processing 3D medical scans, since they usually need a lot of memory and GPU time.
~\cite{neural:3d-cnn-crf}
...
On the \gls{PMHNK} dataset there are some results already. By using the \gls{CT} scans and
...
\begin{quotation}
  Can a better survival prediction be obtained using imaging data than the current volume feature?
\end{quotation}
